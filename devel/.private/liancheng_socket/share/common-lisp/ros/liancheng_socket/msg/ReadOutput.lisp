...
(cl:defmethod station_num-val ((m <ReadOutput>))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<ReadOutput>)))
  ...
  "ce82e22d583170dda6b1ff8f31105f7c")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'ReadOutput)))
  "Returns md5sum for a message object of type 'ReadOutput"
  "ce82e22d583170dda6b1ff8f31105f7c")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<ReadOutput>)))
  ...
  (cl:format cl:nil "Header header~%~%uint8  station_num~%uint16  data~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'ReadOutput)))
  "Returns full string definition for message of type 'ReadOutput"
  (cl:format cl:nil "Header header~%~%uint8  station_num~%uint16  data~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
