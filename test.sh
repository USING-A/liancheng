...
# sudo gnome-terminal --title="roscore" -- bash -c "roscore"
...
# sudo gnome-terminal --title="NXServer" -- bash -c "cd Desktop/robot/; source devel/setup.bash; rosrun liancheng_socket NXServer.py; exec bash"

# echo "NXServer successfully started"

# sleep 2s

# sudo gnome-terminal --title="testPublish" -- bash -c "cd Desktop/robot/; source devel/setup.bash; python src/SimpleNetwork/scripts/testPublisher.py; exec bash"

# echo "Publisher test successfully started"

# sleep 2s

# sudo gnome-terminal --title="RobotPicking" -- bash -c "cd Desktop/robot/; source devel/setup.bash; rosrun liancheng_socket AppleROS.py; exec bash"

# echo "Picking programme successfully started"

sudo gnome-terminal --title="RobotPicking" -- bash -c "cd Desktop/robot/; source devel/setup.bash; rosrun liancheng_socket testPublisher.py; exec bash"